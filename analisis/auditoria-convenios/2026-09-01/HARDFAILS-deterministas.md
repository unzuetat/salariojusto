# Hard-fails deterministas · 2026-09-01

Fichas analizadas: **55**
Hard-fails deterministas: **25** · avisos a verificar a mano: **137**
...
- *7.4** · 11 bloque(s) de más de 100 palabras
...
### convenio-hosteleria-granada — 0 hard-fail(s), 3 aviso(s)
- *11.1** · tablas no audibles: 8 sin scope, 8 sin caption (de 8)
